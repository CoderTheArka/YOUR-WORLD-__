...
if (name1 == localStorage.getItem('username')){
    ...
    create_message_reciver = "<div class='incoming_msg'><div class='incoming_msg_img'> <img id='dede' src='"+pic+"'> </div><div class='received_msg'><div class='received_withd_msg'><p id='ddff'>"+message+"</p><span class='time_date'>"+time+"</span></div></div></div>"
